...
#         lim_low = MillierToXY(38.3,105.5)
#         lim_high = MillierToXY(38.6,106.0)
...
#             # lat.append(random.uniform(38.35,38.55))
#             # lon.append(random.uniform(105.5,106.0))
...
#
#
#         a =np.array([1,1,2.,3.,4],float)
#         a.reshape((5,))
#         cur_action = []
#         for i in range(ac_number):
#             cur_action.append(0.0)
#
...
#         xy3 = MillierToXY(cur_lats[2], cur_lons[2])
#         xy4 = MillierToXY(cur_lats[3], cur_lons[3])
#
#         xy1[0] = (xy1[0] - self.observation_space[0]) / self.xlen
#         xy1[1] = (xy1[1] - self.observation_space[1]) / self.ylen
#         xy2[0] = (xy2[0] - self.observation_space[0]) / self.xlen
#         xy2[1] = (xy2[1] - self.observation_space[1]) / self.ylen
#         xy3[0] = (xy3[0] - self.observation_space[0]) / self.xlen
#         xy3[1] = (xy3[1] - self.observation_space[1]) / self.ylen
#         xy4[0] = (xy4[0] - self.observation_space[0]) / self.xlen
#         xy4[1] = (xy4[1] - self.observation_space[1]) / self.ylen
#
...
#         obs1 = np.append(obs1, differ_angle(cur_hdgs[0], cur_hdgs[1]) / 360)
#         obs1 = np.append(obs1, xy3[0] - xy1[0])
#         obs1 = np.append(obs1, xy3[1] - xy1[0])
#         obs1 = np.append(obs1, differ_angle(cur_hdgs[0], cur_hdgs[2]) / 360)
#         obs1 = np.append(obs1, xy4[0] - xy1[0])
#         obs1 = np.append(obs1, xy4[1] - xy1[0])
#         obs1 = np.append(obs1, differ_angle(cur_hdgs[0], cur_hdgs[3]) / 360)
#
...
#         obs2 = np.append(obs2, differ_angle(cur_hdgs[1], cur_hdgs[0]) / 360)
#         obs2 = np.append(obs2, xy3[0] - xy2[0])
#         obs2 = np.append(obs2, xy3[1] - xy2[0])
#         obs2 = np.append(obs2, differ_angle(cur_hdgs[1], cur_hdgs[2]) / 360)
#         obs2 = np.append(obs2, xy4[0] - xy2[0])
#         obs2 = np.append(obs2, xy4[1] - xy2[0])
#         obs2 = np.append(obs2, differ_angle(cur_hdgs[1], cur_hdgs[3]) / 360)
#
#         obs3 = np.append(obs3, xy3[0])
#         obs3 = np.append(obs3, xy3[1])
#         obs3 = np.append(obs3, cur_hdgs[2] / 360)
#         obs3 = np.append(obs3, xy1[0] - xy3[0])
#         obs3 = np.append(obs3, xy1[1] - xy3[1])
#         obs3 = np.append(obs3, differ_angle(cur_hdgs[2], cur_hdgs[0]) / 360)
#         obs3 = np.append(obs3, xy2[0] - xy3[0])
#         obs3 = np.append(obs3, xy2[1] - xy3[0])
#         obs3 = np.append(obs3, differ_angle(cur_hdgs[2], cur_hdgs[1]) / 360)
#         obs3 = np.append(obs3, xy4[0] - xy3[0])
#         obs3 = np.append(obs3, xy4[1] - xy3[0])
#         obs3 = np.append(obs3, differ_angle(cur_hdgs[2], cur_hdgs[3]) / 360)
#
#         obs4 = np.append(obs4, xy4[0])
#         obs4 = np.append(obs4, xy4[1])
#         obs4 = np.append(obs4, cur_hdgs[3] / 360)
#         obs4 = np.append(obs4, xy1[0] - xy4[0])
#         obs4 = np.append(obs4, xy1[1] - xy4[1])
#         obs4 = np.append(obs4, differ_angle(cur_hdgs[3], cur_hdgs[0]) / 360)
#         obs4 = np.append(obs4, xy2[0] - xy4[0])
#         obs4 = np.append(obs4, xy2[1] - xy4[0])
#         obs4 = np.append(obs4, differ_angle(cur_hdgs[3], cur_hdgs[1]) / 360)
#         obs4 = np.append(obs4, xy3[0] - xy4[0])
#         obs4 = np.append(obs4, xy3[1] - xy4[0])
#         obs4 = np.append(obs4, differ_angle(cur_hdgs[3], cur_hdgs[2]) / 360)
#
#         obs1.reshape((12,))
#         obs2.reshape((12,))
#         obs3.reshape((12,))
...
#
#         obs = self.get_observations()
#         rew1 = -(obs[0][7]**2+obs[0][8]**2)**0.5
#         rew2 = -(obs[1][7]**2+obs[1][8]**2)**0.5
#         rew3 = -(obs[2][7] ** 2 + obs[2][8] ** 2)**0.5
#         adversary_rew = (rew1+rew2+rew3)
#
#         good_rew = -adversary_rew
#
#         if obs[3][0] < 0:
#             good_rew -= obs[3][0]**2
#         elif obs[3][0] > 1:
#             good_rew -= (1-obs[3][0])**2
#         if obs[3][1] < 0:
#             good_rew -= (obs[3][1])**2
#         elif obs[3][1] > 1:
#             good_rew -= (obs[3][1] - 1)**2
#
#         self.reward = [adversary_rew,adversary_rew,adversary_rew,good_rew]
#         #self.reward = [rew1, rew2, rew3, good_rew]
#
#
#
#
...
#         #action = action[idx]
#         bs.traf.ap.selhdgcmd(idx, cur_hdg + action*60)
#
#         # if action <= 0:
...
class BlueSkyEnv(gym.Env):
    ...
    def reset(self):  # resetbl并根据文件创建飞机
        ...
        # self.x = random.uniform(38.48, 38.51)
        # self.y = random.uniform(105.65, 105.90)
        self.x = 38.49
        self.y = 105.7
    ...
    def get_observations(self):
        ...
        obs1 = np.append(obs1, self.x - xy1[0])
        obs1 = np.append(obs1, self.y - xy1[1])
